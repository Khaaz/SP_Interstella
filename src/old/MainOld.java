...
import old.Controllers.Scenes.AScene;
import old.Controllers.Scenes.MenuScene;
...
public class MainOld extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //new SceneSensor();
        SceneManager sceneManager = new SceneManager(primaryStage, sceneMenu);
        sceneManager.start();
        ...
        scene.setOnMousePressed(new EventHandler<MouseEvent>(){
            ...
            public void handle(MouseEvent event) {
                root.getChildren().add(
                        new old.Bullet(event.getSceneX(),
                                s2.body.getY())
                );
            }
        });
